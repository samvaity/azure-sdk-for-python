...
class KeyVaultClientAsync(MultiApiClientMixin):
    ...
    def get_configuration_class(api_version):
        ...
        if api_version == V7_0_VERSION:
            from ..._generated.v7_0.aio import KeyVaultClientConfiguration as ImplConfig
        elif api_version == V2016_10_01_VERSION:
            from ..._generated.v2016_10_01.aio import KeyVaultClientConfiguration as ImplConfig
        else:
